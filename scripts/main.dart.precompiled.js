...
["dart.dom.html", "dart:html", , W, {
  ...
  NodeValidatorBuilder_allowsAttribute_closure: {
    "^": "Closure:8;element_0,attributeName_1,value_2",
    call$1: function(v) {
...
["side_images", "side_images.dart", , F, {
  "^": "",
  initSideImagesUnlessHome: function() {
    if (document.body.id === "site-home")
      return;
    $.images = W._FrozenElementList$_wrap(document.querySelectorAll(".side img"), null);
    F._updateImageClasses();
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_scroll._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.initSideImagesUnlessHome_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  _updateImageClasses: function() {
    ...
    for (t1 = $.images, t1 = t1.get$iterator(t1); t1.moveNext$0();) {
      ...
      if (F._inViewport(image))
        t2.get$classes(image).remove$1(0, "out-of-view");
      else
        t2.get$classes(image).add$1(0, "out-of-view");
    }
  },
  _inViewport: function(image) {
    var t1, t2, t3, t4, $top;
    t1 = J.getInterceptor$x(image);
    t2 = J.get$top$x(t1.getBoundingClientRect$0(image));
    t3 = window.pageYOffset;
    if (typeof t2 !== "number")
      return t2.$add();
    if (typeof t3 !== "number")
      return H.iae(t3);
    t4 = document.documentElement.clientTop;
    if (typeof t4 !== "number")
      return H.iae(t4);
    $top = t2 + t3 + t4;
    t1 = J.get$height$x(t1.getBoundingClientRect$0(image));
    if (typeof t1 !== "number")
      return H.iae(t1);
    t2 = $.scrollTop;
    if (typeof t2 !== "number")
  ...
  initSideImagesUnlessHome_closure: {
    "^": "Closure:8;",
    call$1: function(e) {
      return F._updateImageClasses();
    }
  }
}],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  function initHeader_closure() {
  }
  initHeader_closure.builtin$cls = "initHeader_closure";
  if (!"name" in initHeader_closure)
    initHeader_closure.name = "initHeader_closure";
  $desc = $collectedClasses.initHeader_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initHeader_closure.prototype = $desc;
  function initHeader_closure0(backgroundImage_0, loadingTimer_1) {
    this.backgroundImage_0 = backgroundImage_0;
    this.loadingTimer_1 = loadingTimer_1;
  }
  initHeader_closure0.builtin$cls = "initHeader_closure0";
  if (!"name" in initHeader_closure0)
    initHeader_closure0.name = "initHeader_closure0";
  $desc = $collectedClasses.initHeader_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initHeader_closure0.prototype = $desc;
  function initHeader_closure1() {
  }
  initHeader_closure1.builtin$cls = "initHeader_closure1";
  if (!"name" in initHeader_closure1)
    initHeader_closure1.name = "initHeader_closure1";
  $desc = $collectedClasses.initHeader_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initHeader_closure1.prototype = $desc;
  function _wrapHeaderLetters_closure() {
  }
  _wrapHeaderLetters_closure.builtin$cls = "_wrapHeaderLetters_closure";
  if (!"name" in _wrapHeaderLetters_closure)
    _wrapHeaderLetters_closure.name = "_wrapHeaderLetters_closure";
  $desc = $collectedClasses._wrapHeaderLetters_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _wrapHeaderLetters_closure.prototype = $desc;
