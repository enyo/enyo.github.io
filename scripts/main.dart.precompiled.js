...
["dart.async", "dart:async", , P, {
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "get$_completeError", 2, 2, 6, 7],
...
["", "main.dart", , F, {
  ...
  main: [function() {
    var t1, backgroundImage, e, t2, ratio;
    ...
    t1.get$onLoad(e).get$first(0).then$1(new F.main_closure(backgroundImage));
    ...
    F.updateHeaderSize();
    t1 = window;
    t1 = "scrollY" in t1 ? t1.scrollY : t1.document.documentElement.scrollTop;
    t2 = $.windowHeight;
    if (typeof t1 !== "number")
      return t1.$div();
    if (typeof t2 !== "number")
  ...
  main_closure: {
    "": "Closure:12;backgroundImage_0",
    call$1: function(e) {
      J.set$backgroundImage$x($.headerElement.style, "url(" + this.backgroundImage_0 + ")");
      J.get$classes$x($.headerElement).add$1(0, "image-loaded");
      J.get$classes$x($.headerElement.querySelector("h1")).add$1(0, "relaxed");
      return;
    }
  },
  main_closure0: {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(backgroundImage_0) {
